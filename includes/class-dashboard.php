...
class Dashboard {
     ...
     *  CSS/JS that drives the full-viewport layout is enqueued in enqueue_assets()
     *  on the dashboard_page_ab-dashboard-iframe hook (must run before <head>). */
    ...
    public function enqueue_assets( string $hook ): void {
        ...
        // Iframe page (admin.php?page=ab-dashboard-iframe) - inline CSS/JS
        // must attach here, not inside the page-render callback, so it is
        // printed in <head> before body renders.
        if ( $hook === 'dashboard_page_ab-dashboard-iframe' ) {
        ...
        // Dashboard fallback (index.php) - widget-expansion CSS for users
        // who land here directly (no role->page mapping triggers a redirect).
