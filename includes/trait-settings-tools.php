...
trait Settings_Tools {
     ...
     *
     * Defence-in-depth: even if all_option_keys() somehow contained a core WP option,
     * the protected list below ensures it is skipped. Inlined rather than declared as
     * a trait constant because trait constants require PHP 8.2 and this plugin
     * supports PHP 8.1.
     */
