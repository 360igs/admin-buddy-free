...
class SMTP {
    ...
    public function ajax_test_email(): void {
        ...
        // Use `false !== ...` instead of a truthy check so a transient holding
        // '0' or '' (defensive — we set it to '1' below, but future callers
        // might change that) still triggers the cool-down.
