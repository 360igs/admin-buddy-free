    ...
    public function render_sidebar_user_menu(): void {
        ...
        <div id="ab-sidebar-site-link" class="<?php echo esc_attr( $link_classes ); ?>">
            ...
            <ul class="ab-sidebar-site__submenu" role="menu">
                ...
                ?>
                <li role="none"><a role="menuitem" href="<?php echo esc_url( $bar_node->href ); ?>"<?php if ( ! $is_admin_link ) : ?> target="_blank" rel="noopener"<?php endif; ?>><?php echo wp_kses_post( $bar_node->title ); ?></a></li>
                <?php endforeach; ?>
            </ul>
            <?php endif; ?>
        </div>
